        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            if (slide == 0)
            {
                ...
                if (panel1.Left <= -251)
                {
                    ...
                    next.IconColor = Color.FromArgb(76, 40, 130);
                    back.IconColor = Color.FromArgb(76, 40, 130);
                    slidePass.IconColor = Color.FromArgb(76, 40, 130);
                    pass1.IconColor = Color.FromArgb(76, 40, 130);
                }
            }
            else if (slide == 1)
            {
                ...
                if (panel1.Left <= -502)
                {
                    ...
                    pass1.IconColor = Color.Silver;
                    pass2.IconColor = Color.FromArgb(76, 40, 130);
                    next.IconColor = Color.FromArgb(76, 40, 130);
                    back.IconColor = Color.FromArgb(76, 40, 130);
                }
            }
            else if (slide == 2)
            {
                ...
                if (panel1.Left <= -758)
                {
                    ...
                    slidePass.IconColor = Color.Gainsboro;
                    pass1.IconColor = Color.Silver;
                    pass2.IconColor = Color.Silver;
                    pass3.IconColor = Color.FromArgb(76, 40, 130);
                    next.IconColor = Color.FromArgb(76, 40, 130);
                    back.IconColor = Color.FromArgb(76, 40, 130);
            ...
            else if (slide == 3)
            {
                ...
                if (panel1.Left <= -1010)
                {
                    ...
                    pass1.IconColor = Color.Silver;
                    pass2.IconColor = Color.Silver;
                    pass3.IconColor = Color.Silver;
                    pass4.IconColor = Color.FromArgb(76, 40, 130);
                    next.IconColor = Color.FromArgb(76, 40, 130);
                    back.IconColor = Color.FromArgb(76, 40, 130);
                    //Final = true;
                }
