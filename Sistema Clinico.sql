...
('Oscar','Oscar','Torres','Administrador','Oscar3'),
('Kevin','Kevin','Bonifacio','Administrador','Kennedy4'),
...
('Alexis','Alexis','Alfaro','Administrador','Alexis8'),
('Pablo','Pablo','Escobar','Doctor','Pablo9'),
('Rubi','Rubi','Sanchez','Enfermera','Rubi10'),
('Edwin','Edwin','Melgar','Ingeniero','123')
Go
...
Insert into Citas
values
(SYSDATETIME(),'20200910 10:00','Enfermedad Cronica','Ruby',15.99,369851450),
(SYSDATETIME(),'20200917 9:00','Sintomas de Covid-19','Ruby',25.99,102598171),
(SYSDATETIME(),'20200920 10:00','Chequeo General','Ruby',10.99,863254109),
(SYSDATETIME(),'20201010 10:00','Enfermedad Cronica','Ruby',15.99,369851450),
(SYSDATETIME(),'20201017 9:00','Sintomas de Covid-19','Ruby',25.99,102598171),
(SYSDATETIME(),'20201020 10:00','Chequeo General','Ruby',10.99,863254109),
(SYSDATETIME(),'20201210 10:00','Enfermedad Cronica','Ruby',15.99,369851450),
(SYSDATETIME(),'20201217 9:00','Sintomas de Covid-19','Ruby',25.99,102598171),
(SYSDATETIME(),'20201220 10:00','Chequeo General','Ruby',10.99,863254109),
(SYSDATETIME(),'20201222 11:00','Malestar Estomacal','Ruby',22.99,596321458),
(SYSDATETIME(),'20201228 15:00','Chequeo General','Ruby',10.99,586315774),
(SYSDATETIME(),'20201230 16:00','Dolor de Lumbago','Ruby',15.99,549320157),
(SYSDATETIME(),'20210101 7:00','Infeccion de vias urinarias','Ruby',15.99,145963248),
(SYSDATETIME(),'20210125 14:00','Chequedo de Diabetes','Ruby',15.99,259863104),
(SYSDATETIME(),'20210226 15:00','Chequeo General','Ruby',10.99,586315774),
(SYSDATETIME(),'20210227 16:00','Dolor de Lumbago','Ruby',15.99,549320157),
(SYSDATETIME(),'20210301 7:00','Infeccion de vias urinarias','Ruby',15.99,145963248),
(SYSDATETIME(),'20210320 10:00','Chequeo General','Ruby',10.99,863254109),
(SYSDATETIME(),'20210322 11:00','Malestar Estomacal','Ruby',22.99,596321458),
(SYSDATETIME(),'20210324 13:00','Terapia de Asma','Ruby',35.99,496852301),
(SYSDATETIME(),'20210325 14:00','Chequedo de Diabetes','Ruby',15.99,259863104),
(SYSDATETIME(),'20210418 10:00','Enfermedad Cronica','Ruby',15.99,369851450),
(SYSDATETIME(),'20210419 9:00','Sintomas de Covid-19','Ruby',25.99,102598171),
(SYSDATETIME(),'20210420 10:00','Chequeo General','Ruby',10.99,863254109),
(SYSDATETIME(),'20210422 11:00','Malestar Estomacal','Ruby',22.99,596321458),
(SYSDATETIME(),'20210424 13:00','Terapia de Asma','Ruby',35.99,496852301),
(SYSDATETIME(),'20210425 14:00','Chequedo de Diabetes','Ruby',15.99,259863104),
(SYSDATETIME(),'20210428 15:00','Chequeo General','Ruby',10.99,586315774),
(SYSDATETIME(),'20210430 16:00','Dolor de Lumbago','Ruby',15.99,549320157),
(SYSDATETIME(),'20210501 7:00','Infeccion de vias urinarias','Ruby',15.99,145963248),
(SYSDATETIME(),'20210504 8:00','Infeccion en la piel','Ruby',15.99,105698367),
(SYSDATETIME(),'20210505 7:00','Infeccion de vias urinarias','Ruby',15.99,145963248)
go
--select * from Usuario
