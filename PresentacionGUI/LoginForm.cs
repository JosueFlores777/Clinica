...
namespace PresentacionGUI
{
    public partial class LoginForm : Form
    {
        ...
        private void Usuario_Enter(object sender, EventArgs e)
        {
            ...
            {
                Usuario.Text = "";
                Usuario.ForeColor = Color.FromArgb(65, 49, 149);
                panelUsuario.BackColor = Color.FromArgb(65, 49, 149);
                iconUser.IconColor = Color.FromArgb(65, 49, 149);
        ...
        private void Contraseña_Enter(object sender, EventArgs e)
        {
            ...
            {
                Contraseña.Text = "";
                Contraseña.ForeColor = Color.FromArgb(65, 49, 149);
                panelContraseña.BackColor = Color.FromArgb(65, 49, 149);
                iconPass.IconColor = Color.FromArgb(65, 49, 149);
        ...
        private void ActivarOjo()
        {
            if (iconEye.IconChar == FontAwesome.Sharp.IconChar.EyeSlash) {
                ...
                {
                    iconEye.IconColor = Color.FromArgb(65, 49, 149);
