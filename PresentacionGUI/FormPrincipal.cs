...
namespace PresentacionGUI
{
    public partial class FormPrincipal : Form
    {
        ...
        private void FormPrincipal_Load(object sender, EventArgs e)
        {
            ...
            if (CacheDeUsuario.CargoUsuario == Cargos.Ingeniero)
            {
        ...
        private void DisableButton()
        {
            if (currentBtn != null)
            {
                ...
                currentBtn.IconColor = Color.FromArgb(76, 40, 130);
        ...
        {
            ActivateButton(sender, Color.FromArgb(76, 40, 130));
        ...
        private void Reset()
        {
            ...
            iconFormularioActual.IconColor = Color.FromArgb(76, 40, 130);
            TituloFormularioHijo.Text = "Inicio";
            TituloFormularioHijo.ForeColor = Color.FromArgb(76, 40, 130);
            Close.ForeColor = Color.FromArgb(76, 40, 130);
            Minimizar.ForeColor = Color.FromArgb(76, 40, 130);
            iconUsers.IconColor = Color.FromArgb(76, 40, 130);
            iconPictureBox1.IconColor = Color.FromArgb(76, 40, 130);
            iconPictureBox1.ForeColor = Color.FromArgb(76, 40, 130);
            iconUsers.ForeColor = Color.FromArgb(76, 40, 130);
            linklblEditar.LinkColor = Color.FromArgb(76, 40, 130);
        }
        //Drag Form
